const featuresData = [
  {
    ...
    paragraph:
      "Conocer el ambiente del cual serán extraidos los datos es una misión crucial para el éxito de la implementación de un proyecto de inteligencia de datos.",
  },
  {
    id: 1,
    icon: (
    ...
    title: "Cosecha de alta calidad",
    paragraph:
    "Gracias al monitoreo AgroControl puede ayudar a mejorar el rendimiento de los cultivos al garantizar que se les proporcionen los recursos necesarios en el momento adecuado.",
  },
  {
    id: 1,
    icon: (
    ...
    title: "Amigable para el medio ambiente",
    paragraph:
      "Al permitir a los agricultores optimizar el uso de los recursos, AgroControl puede contribuir a la sostenibilidad ambiental al reducir el desperdicio de agua y otros recursos y mejorar la salud del suelo.",
  },
];
